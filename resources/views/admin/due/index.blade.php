...
<div class="nk-block-head">
    <div class="nk-block-head-content">
        <h3 class="nk-block-title page-title">Company Loan</h3>
    </div>
</div>
@endsection
@section('content')
        ...
        <div class="card-inner card-inner-lg">
            <div class="nk-block">
                <div class="nk-data data-list data-list-s2">
                    <form action="{{ route('admin.due.loan') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="customer_id" id="customer_id" class="form-control">
                                ...
                                <option class="text-uppercase" value="{{ $customer->id }}">{{ $customer->name }} | ({{ number_format($customer->amount,2) }})</option>
                                @endforeach
                            </select>
                        </div>
